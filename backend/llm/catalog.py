...
`GET /api/models` serves this verbatim; the frontend renders provider cards,
...
_GROQ = ProviderInfo(
    ...
    key_steps=[
        ...
        "Click “Create API Key”, name it (e.g. “docchat”), and copy the gsk_… key.",
...
_OPENROUTER = ProviderInfo(
    ...
    key_steps=[
        ...
        "Models ending in “:free” cost nothing (≈20 req/min, 200/day). "
    ...
    models=[
        ...
        ModelInfo(
            ...
            context="1M",
            free=True,
            notes="Best free pick when your PDFs are code-heavy.",
        ),
        ModelInfo(
...
_OPENAI = ProviderInfo(
    ...
    models=[
        ModelInfo(
            ...
            cost="$$$",
            context="400K",
            notes="OpenAI's flagship reasoner — top accuracy for hard documents.",
        ),
        ModelInfo(
            id="gpt-5.4",
            name="GPT-5.4",
        ...
        ModelInfo(
            ...
            context="400K",
            recommended=True,
            notes="Best price/accuracy balance for document Q&A.",
        ),
        ModelInfo(
            id="gpt-4.1",
            name="GPT-4.1",
            ...
            cost="$2/M in",
            context="1M",
            notes="Pick this for very large documents (1M-token context).",
        ),
        ModelInfo(
            id="gpt-4o-mini",
            name="GPT-4o mini",
            ...
            cost="$0.15/M in",
            context="128K",
            notes="Legacy budget option — still fine for simple PDFs.",
        ),
    ],
    embedding_models=[
        ModelInfo(
...
_ANTHROPIC = ProviderInfo(
    ...
    models=[
        ModelInfo(
            ...
            cost="$$$",
            context="200K",
            notes="Anthropic's frontier model — maximum accuracy, best for dense "
...
_GEMINI = ProviderInfo(
    ...
    models=[
        ...
        ModelInfo(
            ...
            cost="$$",
            context="1M",
            notes="Deep reasoning over very long documents.",
        ),
        ModelInfo(
            id="gemini-2.5-flash",
